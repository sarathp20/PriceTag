package com.example.pricetag.classifier;
...
public class ImageClassifier {
    ...
    public ImageClassifier(Activity activity) throws IOException {
        //if needed to change model change the .tflite model in assets with new and paste the name
        //in below file path.
        MappedByteBuffer classifierModel = FileUtil.loadMappedFile(activity,
                "mobilenet_v1_1.0_224_quant.tflite");
        // change label if needed (follow method above described)
